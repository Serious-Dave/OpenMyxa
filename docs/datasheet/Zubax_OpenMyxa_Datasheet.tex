...
\begin{titlepage}
\section*{Overview}
Zubax OpenMyxa is a tightly integrated unit that contains an electric motor with electronic speed controller. This sensorless propeller drive is an open hardware reference design for Mitochondrik module\footnote{Refer to \url{zubax.com/products/mitochondrik} for more information}.
\section*{Features}
...
\begin{ZubaxTableWrapper}{Electrical characteristics}
    \begin{ZubaxWrappedTable}{|c X|c c c|c|}
        ...
        $V_\text{inv}$      & Supply voltage\tnote{a}             & 12   & 36 & 51.0 & V \\
        ...
        $R_\text{phase}$    & Cumulative resistance of the
                              inverter per phase                  &      & 3   &      & $\text{m}\Omega$ \\
...
Zubax OpenMyxa measures the temperature of motor windings by means of the KTY84/130 PTC thermistor. It converts and translates measured data via UAVCAN bus\footnote{Not all versions of Telega support motor temperature measurement. Refer for Telega documentation for more information}.  
...
Zubax OpenMyxa is equipped with a single RGB LED indicator for purposes of status indication and single Green LED for CAN bus transfer indication. 
These LEDs are located on the PCB near the UAVCAN connectors.

\section{Mechanical characteristics}

The drawings \ref{openmyxa_drawing} and \ref{openmyxa_piccino_drawing} document the basic mechanical characteristics of Zubax OpenMyxa,
