...
The drawing \ref{openmyxa_drawing} documents the basic mechanical characteristics 
of Zubax OpenMyxa,such as dimensions and mounting holes placement.

OpenMyxa is mounting on the chassis like a motor. It has 4 M3 mounting holes.

\begin{figure}[b]
    \centering    
    \includegraphics[width=0.99\textwidth]{openmyxa_drawing}
    \caption{OpenMyxa drawing.\label{openmyxa_drawing}}
\end{figure}

\begin{ZubaxSimpleTable}{Mechanical characteristics}{|c l|c|c|X|}
    Symbol & Parameter   & Value   & Unit & Note                 \\
    $m$    & Weight      & 207     &   g  & Cables not included  \\
    IP     & Ptotection  & 65      & - & The ESC is conformally coated to protect from wet conditions \\                        
\end{ZubaxSimpleTable}
